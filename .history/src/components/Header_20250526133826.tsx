    ...
    <header className={`fixed w-full z-40 transition-all duration-300 bg-white shadow-md ${isScrolled ? 'py-2' : 'py-4'}`}>
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between">
          ...
          <div className={`lg:hidden flex items-center gap-x-4 ${isRTL ? 'order-1' : 'order-3'} relative z-50`}>
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 z-40 lg:hidden">
            ...
            <div
              className={`absolute top-[72px] w-[90vw] max-w-xs bg-white rounded-xl shadow-2xl p-6 
