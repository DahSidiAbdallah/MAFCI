...
const ServicesSection: React.FC = () => {
  // Version 1: Using SVG patterns (Enable this by commenting Version 2 and uncommenting this)
  /*
  return (
  ...
  // Version 2: Using actual image background (Current active version)
  return (
    <section id="services" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Blueprint-style diagonal lines for construction theme */}
        <div 
          className="absolute inset-0"
          style={{ 
            backgroundImage: 'repeating-linear-gradient(45deg, rgba(255,255,255,0.03) 0px, rgba(255,255,255,0.03) 1px, transparent 1px, transparent 25px)',
            opacity: 0.2
          }}
        ></div>
      </div>
