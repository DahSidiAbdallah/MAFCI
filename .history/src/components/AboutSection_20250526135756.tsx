...
import ImageAcc1 from '../assets/acc-1.jpg';
import ImageM1 from '../assets/m1.jpg';
...
const StatsCard: React.FC<StatsCardProps> = ({ icon, titleKey, value, isRTL }) => {
  ...
  return (
    <div className={`bg-white p-6 rounded-lg shadow-md flex items-center hover:shadow-lg transition-shadow ${isRTL ? 'flex-row-reverse' : ''}`}>
    ...
    <section id="about" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className={`flex flex-col justify-center ${isRTL ? 'text-right' : 'text-left'}`} data-aos={isRTL ? "fade-right" : "fade-left"} data-aos-delay="200">
          ...
          <div className={`flex flex-col ${isRTL ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-8`}>
            ...
            <div className={`md:w-2/3 ${isRTL ? 'text-right' : 'text-left'}`}>
              <blockquote className={`text-xl italic text-gray-700 mb-4 ${isRTL ? 'border-r-4 pr-4' : 'border-l-4 pl-4'} border-primary`}>
                <span className="text-2xl text-primary">" </span>{t('about.presidentQuote')}<span className="text-2xl text-primary"> "</span>
              </blockquote>
