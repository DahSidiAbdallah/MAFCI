        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div data-aos="fade-right" data-aos-delay="100">
            <div className="grid grid-cols-2 gap-4 h-full">
              <img 
                src="https://images.pexels.com/photos/8961315/pexels-photo-8961315.jpeg?auto=compress&cs=tinysrgb&w=1600" 
                alt="Équipe MAFCI" 
                className="rounded-lg shadow-md h-full object-cover"
              />
              <img 
                src="https://images.pexels.com/photos/5976503/pexels-photo-5976503.jpeg?auto=compress&cs=tinysrgb&w=1600" 
                alt="Équipe MAFCI" 
                className="rounded-lg shadow-md h-full object-cover"
              />
            </div>
