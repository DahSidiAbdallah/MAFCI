        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div data-aos="fade-right" data-aos-delay="100">
            <div className="grid grid-cols-2 gap-4 h-full">
              <img 
                src={ImageAcc1} // Use the imported image: acc-1.jpg
                alt="Description de l'image acc-1" // Update with relevant alt text
                className="rounded-lg shadow-md h-full object-cover"
              />
              <img 
                src={ImageM1} // Use the imported image: m1.jpg
                alt="Description de l'image m1" // Update with relevant alt text
                className="rounded-lg shadow-md h-full object-cover"
              />
            </div>
          </div>
