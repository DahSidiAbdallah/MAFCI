      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex lg:items-center lg:justify-end lg:order-2 rtl:lg:order-1 lg:flex-grow">
            ...
            <nav className="flex items-center space-x-6 xl:space-x-8 order-1 rtl:order-3 mx-auto rtl:ml-0 rtl:mr-auto">
            ...
            <div className="flex items-center space-x-4 xl:space-x-6 order-3 rtl:order-1 ml-auto rtl:ml-0 rtl:mr-auto">
              ...
              <a href="#contact" className="bg-primary text-white px-6 py-2 rounded-md hover:bg-primary-dark transition-colors whitespace-nowrap">{t('nav.contact')}</a>
            </div>
          </div>
